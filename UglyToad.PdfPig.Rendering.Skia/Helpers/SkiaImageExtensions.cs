            ...
            try
            {
                ...
                if (pdfImage.SoftMaskImage?.TryGenerate(out mask) == true)
                {
                    ...
                    if (!sMaskPixmap.GetPixelSpan().IsEmpty)
                    {
                        ...
                        if (pdfImage.SoftMaskImage.ShouldInvertColor)
                        {
                            // MOZILLA-LINK-3264-0.pdf 
                            // C:\Users\Bob\Documents\Pdf\Stressful PDF Corpus\mozilla\MOZILLA-LINK-4246-2.pdf
                            // C:\Users\Bob\Documents\Pdf\Stressful PDF Corpus\mozilla\MOZILLA-LINK-4293-0.pdf
                            // C:\Users\Bob\Documents\Pdf\Stressful PDF Corpus\mozilla\MOZILLA-LINK-4314-0.pdf
                            // C:\Users\Bob\Documents\Pdf\Stressful PDF Corpus\mozilla\MOZILLA-LINK-3758-0.pdf
                            // TODO - Untested
                ...
                else if (pdfImage.ImageDictionary.TryGet(NameToken.Mask, out ArrayToken maskArr))
                {
                    ...
                    var range = ColorSpaceDetailsByteConverter.Convert(pdfImage.ColorSpaceDetails!, bytes,
                        pdfImage.BitsPerComponent, bytes.Length / pdfImage.ColorSpaceDetails!.NumberOfColorComponents, 1);
